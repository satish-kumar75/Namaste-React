...
import { ReactComponent as ToggleLightIcon } from "../../assets/light.svg";
import { ReactComponent as ToggleDarkIcon } from "../../assets/dark.svg";
...
const BtnToggleTheme = ({ className }) => {
  ...
  return (
    <Button addClass={className} onClick={toggleTheme} label="theme toggle">
